...
vars = {
  ...
  'skia_revision': '86b05d9a1f65b26f1ad46bef8dea37f40e084ed2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b19c659b4179f367b525e8dc0a9101d1248e20a6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@671ddd771cb85b04f57bbd79feaae91c65bbda44',
    'condition': 'checkout_src_internal',
  },
