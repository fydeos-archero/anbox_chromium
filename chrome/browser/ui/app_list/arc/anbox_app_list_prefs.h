...
#ifndef CHROME_BROWSER_UI_APP_LIST_ARC_ANBOX_APP_LIST_PREFS_H_
#define CHROME_BROWSER_UI_APP_LIST_ARC_ANBOX_APP_LIST_PREFS_H_
...
class AnboxAppListPrefs : public KeyedService,
 ...
 public:
  ...
  class Observer {
   public:
    ...
    // Notifies that AnboxAppListPrefs is destroyed.
  ...
  static AnboxAppListPrefs* Create(Profile* profile);

  // Convenience function to get the AnboxAppListPrefs for a BrowserContext. It
  // will only return non-null pointer for the primary user.
  static AnboxAppListPrefs* Get(content::BrowserContext* context);
 ...
 private:
  ...
  AnboxAppListPrefs(Profile* profile);
  ...
  DISALLOW_COPY_AND_ASSIGN(AnboxAppListPrefs);
};

#endif  // CHROME_BROWSER_UI_APP_LIST_ARC_ANBOX_APP_LIST_PREFS_H_
