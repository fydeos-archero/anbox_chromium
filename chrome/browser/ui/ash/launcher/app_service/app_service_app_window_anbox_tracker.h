...
#ifndef CHROME_BROWSER_UI_ASH_LAUNCHER_APP_SERVICE_APP_SERVICE_APP_WINDOW_ANBOX_TRACKER_H_
#define CHROME_BROWSER_UI_ASH_LAUNCHER_APP_SERVICE_APP_SERVICE_APP_WINDOW_ANBOX_TRACKER_H_
...
// AppServiceAppWindowAnboxTracker observes the ArcAppListPrefs to handle ARC app
// window special cases, e.g. task id, closing ARC app windows, etc.
class AppServiceAppWindowAnboxTracker : public AnboxAppListPrefs::Observer{
                                      // public arc::AnboxSessionManager::Observer {
 public:
  explicit AppServiceAppWindowAnboxTracker(
      AppServiceAppWindowLauncherController* app_service_controller);
  ~AppServiceAppWindowAnboxTracker() override;

  AppServiceAppWindowAnboxTracker(const AppServiceAppWindowAnboxTracker&) = delete;
  AppServiceAppWindowAnboxTracker& operator=(
      const AppServiceAppWindowAnboxTracker&) = delete;
  ...
  void OnAppStatesChanged(const std::string& app_id,
                          const AnboxAppListPrefs::AppInfo& app_info) override;
