...
#ifndef CHROME_BROWSER_UI_ASH_LAUNCHER_ANBOX_APP_WINDOW_LAUNCHER_CONTROLLER_H_
#define CHROME_BROWSER_UI_ASH_LAUNCHER_ANBOX_APP_WINDOW_LAUNCHER_CONTROLLER_H_
...
class AnboxAppWindowLauncherController : public AppWindowLauncherController,
 ...
 public:
  explicit AnboxAppWindowLauncherController(ChromeLauncherController* owner);
  ~AnboxAppWindowLauncherController() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(AnboxAppWindowLauncherController);
};

#endif  // CHROME_BROWSER_UI_ASH_LAUNCHER_ANBOX_APP_WINDOW_LAUNCHER_CONTROLLER_H_
