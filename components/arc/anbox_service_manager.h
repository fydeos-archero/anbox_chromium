...
#ifndef COMPONENTS_ARC_ANBOX_SERVICE_MANAGER_H_
#define COMPONENTS_ARC_ANBOX_SERVICE_MANAGER_H_
...
class AnboxServiceManager {
 public:
  ...
  static AnboxServiceManager* Get();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(AnboxServiceManager);
};

}  // namespace arc

#endif  // COMPONENTS_ARC_ANBOX_SERVICE_MANAGER_H_
