...
#ifndef COMPONENTS_ARC_ARCHERO_SERVICE_MANAGER_H_
#define COMPONENTS_ARC_ARCHERO_SERVICE_MANAGER_H_
...
class ArcHeroServiceManager {
 public:
  ...
  static ArcHeroServiceManager* Get();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ArcHeroServiceManager);
};

}  // namespace arc

#endif  // COMPONENTS_ARC_ARCHERO_SERVICE_MANAGER_H_